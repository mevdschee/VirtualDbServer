...
$callStatement = $dbh->prepare("INSERT INTO `calls` (`id`, `client_ip`, `application_ip`, `session_id`, `request_uri`, `request_id`, `database`, `created_at`, `created_at_usec`, `call_time`, `execution_time`, `query_time`, `query`)
