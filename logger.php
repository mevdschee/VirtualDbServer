...
$callStatement = $dbh->prepare("INSERT INTO `calls` (`id`, `client_ip`, `application_ip`, `session_id`, `user_id`, `request_uri`, `request_id`, `database`, `created_at`, `created_at_msec`, `call_time`, `execution_time`, `query_time`, `query`, `json_error`, `response_size`)
